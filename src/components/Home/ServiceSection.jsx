...
`,
  ...
  },
  {
    ...
    desc: `Altering or replacing a vehicle's Engine Control Unit (ECU) software to optimize engine performance, fuel efficiency
​`,
    image: "/gray.avif",
  ...
  {
    title: "DPF",
    desc: `Professional exhaust and DPF cleaning to keep your car compliant.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[95%] rounded-lg mx-auto h-92 object-cover"
                    onError={(e) => {
                      e.currentTarget.onerror = null;
                      e.currentTarget.src = "/logo1.jpg"; // fallback logo
                    }}
                  />
